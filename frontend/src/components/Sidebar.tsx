...
import { User as UserIcon, Settings, LogOut, Check, Search, Users, UserPlus, Crown } from 'lucide-react';
          ...
          <div className="relative">
            ...
            {showSettings && (
              <div className="absolute top-full right-0 mt-2 w-56 bg-slate-800 border border-slate-600 rounded-lg shadow-lg z-50">
                ...
                {/* Ajusta permissão do botão de cadastro */}
